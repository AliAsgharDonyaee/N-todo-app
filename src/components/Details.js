...
function Details() {
	...
	return (
		<div className='mx-auto w-11/12 h-1/3 border-b-2 border-gray-200 grid grid-cols-2 grid-rows-2 gap-4'>
			<div className='my-auto w-full h-1/2 flex items-center'>
				<div className='mr-2 w-1 h-full bg-lime-500/75 rounded-full'></div>
				<div>
					<p className='text-base text-gray-400'>total todos</p>
					<p className='text-xl text-slate-800'>{state?.length}</p>
				</div>
			</div>
			<div className='my-auto w-full h-1/2 flex items-center'>
				<div className='mr-2 w-1 h-full bg-rose-600/75 rounded-full'></div>
				<div>
			...
			<div className='my-auto w-full h-1/2 flex items-center'>
				<div className='mr-2 w-1 h-full bg-blue-700/75 rounded-full'></div>
				<div>
			...
			<div className='my-auto w-full h-1/2 flex items-center'>
				<div className='mr-2 w-1 h-full bg-orange-500/75 rounded-full'></div>
				<div>
